...
$pluginURI = get_stylesheet_directory_uri() . '/js/';


// load scripts
if (!is_admin()) add_action( 'init', 'photo_galleria_load_scripts' );
function photo_galleria_load_scripts( ) {
	wp_enqueue_script('photo-galleria', get_stylesheet_directory_uri() . '/js/photo-galleria/js/jquery.galleria.js', array('jquery'));
	wp_enqueue_style('photo-galleria-css', get_stylesheet_directory_uri() . '/js/photo-galleria/css/galleria.css', array(), '1.0' );
}
